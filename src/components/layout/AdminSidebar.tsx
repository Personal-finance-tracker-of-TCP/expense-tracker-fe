...
const adminNavigationItems = [
  ...
  {
    href: "/admin/bankhub-sandbox",
    label: "BankHub Sandbox",
    icon: ShieldCheck,
    tone: "bg-emerald-400",
  },
  {
        ...
        <nav className="relative flex-1 px-4 py-5">
          ...
          <div className="mt-6 rounded-3xl border border-white/10 bg-white/8 p-4">
            <div className="flex items-center gap-3">
              <span className="flex h-9 w-9 items-center justify-center rounded-2xl bg-white/10 text-teal-100">
                <Link2 className="h-4 w-4" />
              </span>
              <div className="min-w-0">
                <p className="text-sm font-bold text-white">BankHub & SePay</p>
                <p className="mt-0.5 text-xs leading-5 text-teal-100/70">
                  Theo dõi kết nối và webhook thật từ backend.
                </p>
              </div>
            </div>
          </div>
